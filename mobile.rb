...
DATA_HEADERS = %w[ResultDeviceName ResultId ResultSurveyedDate ResultSurveyedEndDate ScreenResultAnswerDate ScreenText ScreenResultAnswerText]
ALL_DATA_HEADERS = %w[ResultDeviceName ResultId SurveyName ResultSurveyedDate ResultSurveyedEndDate ScreenResultAnswerDate ScreenText ScreenTypeName ScreenResultAnswerText]
